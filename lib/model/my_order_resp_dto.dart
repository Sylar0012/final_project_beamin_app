...
List<MyOrderRespDto> myOrderRespDtoList = [
  MyOrderRespDto(
    ...
    price: 17000,
    store: Store(id: 1, name: "네네치킨", deliveryCost: 3000, deliveryHour: "25~30분"),
  ),
  MyOrderRespDto(
    id: 2,
    name: "양념 치킨",
  ...
  MyOrderRespDto(
    ...
    price: 17000,
    store: Store(id: 3, name: "도미노피자", deliveryCost: 3000, deliveryHour: "25~30분"),
  ),
  MyOrderRespDto(
    id: 5,
    name: "불고기 피자",
  ...
  MyOrderRespDto(
    ...
    price: 5800,
    store: Store(id: 5, name: "롯데리아", deliveryCost: 3000, deliveryHour: "25~30분"),
  ),
  MyOrderRespDto(
    id: 8,
    name: "데리 버거 세트",
  ...
  MyOrderRespDto(
    ...
    price: 13000,
    store: Store(id: 7, name: "죠스떡볶이", deliveryCost: 3000, deliveryHour: "25~30분"),
  ),
  MyOrderRespDto(
    id: 11,
    name: "버섯 크림 떡볶이",
  ...
  MyOrderRespDto(
    ...
    price: 9000,
    store: Store(id: 9, name: "본 비빔밥", deliveryCost: 3000, deliveryHour: "25~30분"),
  ),
  MyOrderRespDto(
    id: 14,
    name: "산채 비빔밥",
